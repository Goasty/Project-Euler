...
def main():
    ...
    while(True):
        ...
        if number_of_current_divisors > current_most_divisores:
            current_most_divisores = number_of_current_divisors
            print(triangle_number)
            print(current_most_divisores)
        if current_most_divisores > target_number_of_divisors:
            print(triangle_number)
            break
